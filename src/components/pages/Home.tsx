...
export default function Home({ productData }: any) {
  // const all = ["/collectionII_big.jpg", "/banner1.jpg"];
  const { show } = usePop();
  const [newArrival, setNewArrival]: any = useState(productData);
  ...
  return (
    <main className="box-border overflow-hidden">
      ...
      <section className="flex items-center m-auto w-full top-0">
        ...
        {/* mobile  */}
        <div className="sm:hidden relative block h-[83vh] w-full">
          <img
